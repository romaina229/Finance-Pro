...
class Organization extends Model
{
    ...
    protected $fillable = ['name','acronym','legal_status','registration_number','country','city','address','logo_path','default_currency','fiscal_year_start_month','is_active'];
    protected $casts = ['is_active' => 'boolean', 'fiscal_year_start_month' => 'integer'];
