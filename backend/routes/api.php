...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('org.access')->prefix('organizations/{organization}')->group(function () {
        ...
        Route::get('cash', [\App\Http\Controllers\Api\CashController::class, 'index']);
        Route::post('cash', [\App\Http\Controllers\Api\CashController::class, 'storeRegister'])->middleware('permission:cash.manage');
        Route::get('cash/{cashRegister}/transactions', [\App\Http\Controllers\Api\CashController::class, 'transactions']);
        Route::post('cash/{cashRegister}/transactions', [\App\Http\Controllers\Api\CashController::class, 'storeTransaction'])->middleware('permission:cash.manage');
        Route::get('cash/{cashRegister}/reconciliations', [\App\Http\Controllers\Api\CashController::class, 'reconciliations']);
        Route::post('cash/{cashRegister}/reconciliations', [\App\Http\Controllers\Api\CashController::class, 'reconcile'])->middleware('permission:cash.manage');
        ...
        Route::get('reports', fn () => null); Route::post('reports/generate', fn () => null); Route::get('audit-logs', fn () => null);
    });
