...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware(['org.access', AuditTrail::class])->prefix('organizations/{organization}')->group(function () {
        // --- Facturation : volontairement HORS du middleware org.billing ---
        // Une organisation bloquée pour impayé doit pouvoir consulter et régler
        // sa facture — sinon c'est une impasse sans issue (voir EnsureOrganizationBilling).
        Route::get('invoices', [\App\Http\Controllers\Api\PaymentController::class, 'invoices']);
        Route::post('invoices/{invoice}/pay', [\App\Http\Controllers\Api\PaymentController::class, 'initiate']);

        Route::middleware('org.billing')->group(function () {
